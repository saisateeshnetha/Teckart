...
const Banner = () => {
  ...
  const AddBanner = () => {
    ...
    axios
      .post(URLS.AddHomeAbout, dataArray, {
  ...
  const EditBanner = () => {
    ...
    axios
      .put(URLS.UpdateHomeAbout + formid, dataArray, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
  ...
  const DeleteBanner = data => {
    ...
    var remid = data._id
    axios
      .delete(URLS.DeleteHomeAbout + remid, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
  ...
  const GetAllBanners = () => {
    ...
    axios
      ...
      .then(res => {
        setbanner(res.data.homecontents)
      })
  }
  const clearForm1 = () => {
    setFiles1({
  ...
  const searchAll = e => {
    ...
    axios
      .post(
        URLS.GetHomeAboutSearch + `${e.target.value}`,
        {},
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="TecKart Admin" breadcrumbItem="Home About us" />

          <Row>
            <Col md={4}>
              <Card>
                <CardHeader className="bg-white">
                  <CardTitle>Add Home About us</CardTitle>
                </CardHeader>
                <CardBody>
                  <Form
                    onSubmit={e => {
            ...
            <Col md={8}>
              <Card>
                <CardHeader className="bg-white">
                  <CardTitle>Home About us List</CardTitle>
                </CardHeader>
