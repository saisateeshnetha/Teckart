const projects = [
  {
    ...
    files: [
      { name: "TecKart Admin Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "TecKart Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "TecKart Admin Logo.Zip", size: "2.02 MB", link: "#" },
  ...
  },
  {
    id: 4,
    img: "img5",
    name: "TecKart Admin Dashboard UI",
